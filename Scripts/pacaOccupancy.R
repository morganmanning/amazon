...
# that dipped standard error
which(orderedModelsEstimates$SE/orderedModelsEstimates$Estimate == min(orderedModelsEstimates$SE/orderedModelsEstimates$Estimate))
allModelsOrdered[[88]]
